...
def showStartScreen():
	...
	while True:
		...
		rotatedRect2.center = (SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2)
...
def drawGrid():
	for x in range(0, SCREEN_WIDTH, CELL_SIZE): # draw vertical lines
		pygame.draw.line(DISPLAYSURF, DARKGRAY, (x, 0), (x, SCREEN_HEIGHT))
	for y in range(0, SCREEN_HEIGHT, CELL_SIZE): # draw horizontal lines
		pygame.draw.line(DISPLAYSURF, DARKGRAY, (0, y), (SCREEN_WIDTH, y))
